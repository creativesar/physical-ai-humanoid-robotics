...
- **Framework**: FastAPI
- **AI Services**: Cohere API (embeddings and generation)
...
│ - Auth UI       │    │ - Cohere Service │    │   embeddings    │
...
- **Cohere API errors**: Verify your API key is correct and you have sufficient credits
...
- **Slow responses**: Check your Cohere rate limits and Qdrant performance
