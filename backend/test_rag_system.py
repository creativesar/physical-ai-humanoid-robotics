#!/usr/bin/env python3
"""
Comprehensive test script to verify RAG system including Qdrant and OpenRouter
"""
import asyncio
import os
...
async def test_full_rag_system():
    """
    Test the complete RAG system including Qdrant and OpenRouter
    """
    print("Testing Full RAG System (Qdrant + OpenRouter)...")

    try:
        # Initialize services
        print("1. Initializing OpenRouter service...")
        ...
        query_embedding = await openrouter_service.generate_embeddings_query("What is this test about?")
        ...
        print("✅ OpenRouter is responding properly")
...
async def test_individual_components():
    ...
    print("\nTesting OpenRouter only...")
    try:
        openrouter = OpenRouterService()
        response = await openrouter.generate_response("Test message")
        print(f"✓ OpenRouter response: {response[:50]}...")
    except Exception as e:
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("Both Qdrant and OpenRouter are working correctly together.")
    else:
