...
const modules = [
  ...
  },
  {
    ...
    description: 'Develop intelligent robotic systems using NVIDIA\'s AI and robotics platform.',
    objectives: [
  ...
  },
  {
    ...
    description: 'Enable robots to perceive, understand, and interact with the world using combined capabilities.',
    objectives: [
