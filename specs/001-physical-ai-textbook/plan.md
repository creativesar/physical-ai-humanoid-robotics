...
│                 │    │                  │    │                 │
│ - TypeScript    │    │ - OpenRouter API │    │ - User data     │
...
- **AI Services**: OpenRouter API for RAG functionality
...
- **RAG Service**: OpenRouter API-powered question answering with context
...
- **Vectors**: OpenRouter API embeddings (1024 dimensions)
- **Payload**:
...
### 5.2 OpenRouter API Integration
- **Embedding Model**: OpenRouter's embedding model for both English and Urdu
- **Generation Model**: OpenRouter's model for question answering
